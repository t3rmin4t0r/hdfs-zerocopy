...
public class ShortCircuitTest extends Configured implements Tool {
    public static void main(String[] args) throws Exception {
        Configuration conf = new Configuration();
        int res = ToolRunner.run(conf, new ShortCircuitTest(), args);
        System.exit(res);
    }
    ...
    public int run(String[] args) throws Exception {
        ...
        if(!line.hasOption("input")) {
          ...
          f.printHelp("ShortCircuitTest", options);
          return 1;
        }
        ...
        Job job = new Job(conf, "ShortCircuitTest");
